...
export interface PosCartBodyProps {
        ...
        <div className="flex items-center gap-3">
          ...
          {isMobile && onClose && (
            <button
              type="button"
              onClick={onClose}
              className="cursor-pointer p-2 rounded-xl text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
