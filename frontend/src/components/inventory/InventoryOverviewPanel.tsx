...
export function InventoryOverviewPanel({
  ...
  const filterKey = `${products.length}-${selectedCategoryName}-${selectedStockFilter}`;
              ...
              <div className="flex items-center p-1 bg-slate-100 dark:bg-slate-800/80 rounded-2xl border border-slate-200/80 dark:border-slate-700">
                {[
                  ...
                  <button
                    ...
                    className={`cursor-pointer px-3.5 py-1.5 rounded-xl text-xs font-extrabold transition-all ${selectedStockFilter === tab.id
